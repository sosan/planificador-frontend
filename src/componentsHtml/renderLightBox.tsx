export const htmlLightBox = `<div class='dhx_cal_ltext contenedor_botones_lightbox' >
    <div class='' style='display: flex; flex-direction: row; ' >
        <button id='boton_menos_lightbox' class='boton_ligthbox boton_menos_lightbox'>-</button> 
        <input id='numero_dias' class='noselect input_numero_dias' name='numero_dias' type='number' value='3' min='1' max='99999'>
